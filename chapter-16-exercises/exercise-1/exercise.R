...
ggplot(data = diamond_sample) + geom_point(mapping = aes(x = carat, y = price))

# Draw the same plot as above, but color each of the points based on their 
# clarity.
ggplot(data = diamond_sample) + geom_point(mapping = aes(x = carat, y = price, color = clarity))
...
ggplot(data = diamond_sample) + geom_point(mapping = aes(x = carat, y = price), color = "blue")


# Draw a scatter plot for `diamonds_sample` of `price` by `carat`, where each
# point has an aesthetic _shape_ based on the diamond's `cut`.
ggplot(data = diamond_sample) + geom_point(mapping = aes(x = carat, y = price, shape = cut))



# Draw a scatter plot for `diamonds_sample` of *`cut`* by `carat`, where each
# point has an aesthetic _size_ based on the diamond's *`price`*
ggplot(data = diamond_sample) + geom_point(mapping = aes(x = carat, y = cut, size = price))


# Try coloring the above plot based on the diamond's price!
ggplot(data = diamond_sample) + geom_point(mapping = aes(x = carat, y = price, shape = cut, color = price))


# Draw a line plot (with line geometry) for `diamonds_sample`. The x-position 
# should be mapped to carat, y-position to price, and color to cut.
ggplot(data = diamond_sample) + geom_point(mapping = aes(x = carat, y = price, color = cut))


# That's kind of messy. Try using `smooth` geometry instead.
ggplot(data = diamond_sample) + geom_smooth(mapping = aes(x = carat, y = price, color = cut))
...
ggplot(data = diamond_sample) + geom_col(mapping = aes(x = carat, y = price))


# Add an aesthetic property that will _fill_ each bar geometry based on the 
# `clarity` of the diamonds. 
# What kind of chart do you get?
ggplot(data = diamond_sample) + geom_col(mapping = aes(x = carat, y = price, fill = clarity))
...
ggplot(data = diamond_sample) + geom_point(mapping = aes(x = carat, y = price, color = price), alpha = 0.3) + 
  geom_smooth(mapping = aes(x = carat, y = price, color = price), se = FALSE)
